...
class AudioCNN(nn.Module):
    def __init__(self, dropout_rate=0.5):
        ...
        self.conv1 = nn.Conv1d(8, 32, kernel_size=3, stride=1, padding=1)  # Increased from 16 to 32
        self.bn1 = nn.BatchNorm1d(32)  # Adjusted to match conv1
        self.relu1 = nn.ReLU()
        self.dropout1 = nn.Dropout(dropout_rate)
        
        self.conv2 = nn.Conv1d(32, 64, kernel_size=3, stride=1, padding=1)  # Increased from 32 to 64
        self.bn2 = nn.BatchNorm1d(64)  # Adjusted to match conv2
        self.relu2 = nn.ReLU()
        self.dropout2 = nn.Dropout(dropout_rate)
        
        self.conv3 = nn.Conv1d(64, 128, kernel_size=3, stride=1, padding=1)  # Increased from 64 to 128
        self.bn3 = nn.BatchNorm1d(128)  # Adjusted to match conv3
        self.relu3 = nn.ReLU()
        self.dropout3 = nn.Dropout(dropout_rate)
        
        self.conv4 = nn.Conv1d(128, 256, kernel_size=3, stride=1, padding=1)  # Increased from 128 to 256
        self.bn4 = nn.BatchNorm1d(256)  # Adjusted to match conv4
        self.relu4 = nn.ReLU()
        self.dropout4 = nn.Dropout(dropout_rate)
        
        self.conv5 = nn.Conv1d(256, 512, kernel_size=3, stride=1, padding=1)  # Increased from 256 to 512
        self.bn5 = nn.BatchNorm1d(512)  # Adjusted to match conv5
        self.relu5 = nn.ReLU()
        self.dropout5 = nn.Dropout(dropout_rate)

        #self.lstm = nn.LSTM(512, 512, batch_first=True)  # New LSTM layer
        self.fc1 = nn.Linear(512*500, 1024)  # Adjusted to match conv5
        self.fc2 = nn.Linear(1024, 8*500)
