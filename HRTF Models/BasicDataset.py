...
class BasicDataset(Dataset):
    ...
    def load(self, sofa_path):
        ...
        angle90 = torch.tensor(90., dtype=torch.float32)
    ...
    def get_all(self):
        ...
        hrirs45 = []
        angles45 = []
        for hrir0, angle0, hrir90, angle90, hrir45, angle45 in self.targets:
            hrirs0.append(hrir0.numpy())
            angles0.append(angle0.numpy())
            hrirs90.append(hrir90.numpy())
            angles90.append(angle90.numpy())
            hrirs45.append(hrir45.numpy())
            angles45.append(angle45.numpy())

        return hrirs0, angles0, hrirs90, angles90, hrirs45, angles45